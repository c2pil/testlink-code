  ...
  <div>
    ...
    <div class="groupBtn">
      <span style="float:left;">  
        <form method="post" action="{$createUserAction}" name="launch_create">
          ...
          <input type="submit" name="doCreate"  value="{$labels.btn_create}" class="btn btn-primary btn-white btn-round"/>
        </form>
      </span>

      <span>
        <form method="post" action="{$exportUsersAction}" name="launch_export" style="inline;">
          <input type="submit" id="export"  name="export" value="{$labels.btn_export}" class="btn btn-primary btn-white btn-round" style="margin-left: 3px;">
        </form>
      </span>
    ...
    <div class="groupBtn">
        <form method="post" action="{$editUserAction}" name="manage_user" style="inline;">
          ...
          <input type="submit" id="manage_user"  name="manage_user" value="{$labels.btn_manage_user}" class="btn btn-primary btn-white btn-round" style="margin-left: 3px;">
        </form>
    </div>
  </div>
