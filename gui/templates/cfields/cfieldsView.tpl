...
display_on_exec,available_on"} {include file="inc_head.tpl"
enableTableSorting="yes" openHead="yes"} {include
file="bootstrap.inc.tpl"}
...
<body class="testlink">
	...
	<div class="page-content">
		...
		{if $gui->cf_map != '' && $gui->drawControlsOnTop} {include
		file="cfields/{$tplBN}Controls.inc.tpl" suffix="Top"} {/if} {if
		$gui->cf_map != '' }
		<table class="table table-bordered sortable">
			...
			<tr>
				<td width="10%" class="bold"><a
					href="lib/cfields/cfieldsEdit.php?do_action=edit&cfield_id={$cf_def.id}"
				...
				<td align="center" width="5%">{if $cf_def.show_on_execution}<img
					src="{$tlImages.checked}">{/if}
				</td>
		...
		{/if} {include file="cfields/{$tplBN}Controls.inc.tpl"
		suffix="Bottom"}
